# EIP-7732 Light Client -- Networking
...
The [Electra light client networking specification](../../../electra/light-client/p2p-interface.md) is extended to exchange [EIP-7732 light client data](./sync-protocol.md).
...
| `ELECTRA_FORK_VERSION`                                 | `electra.LightClientFinalityUpdate` |
| `EIP7732_FORK_VERSION` and later                       | `eip7732.LightClientFinalityUpdate` |
...
| `ELECTRA_FORK_VERSION`                                 | `electra.LightClientOptimisticUpdate` |
| `EIP7732_FORK_VERSION` and later                       | `eip7732.LightClientOptimisticUpdate` |
...
| `ELECTRA_FORK_VERSION`                                 | `electra.LightClientBootstrap`     |
| `EIP7732_FORK_VERSION` and later                       | `eip7732.LightClientBootstrap`     |
...
| `ELECTRA_FORK_VERSION`                                 | `electra.LightClientUpdate`      |
| `EIP7732_FORK_VERSION` and later                       | `eip7732.LightClientUpdate`      |
